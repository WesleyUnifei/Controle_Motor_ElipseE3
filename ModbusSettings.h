...
#define MB_BUFFER_SIZE			128		// Size of content buffer on ModbusData - Depends on the size of your memory map
...
// Memory map settings ====================================
/*
 * Inputs s�o usadas para leitura
 * Outputs s�o usadas para leitura e escrita
 */
#if MB_LIBMODBUS_TESTS == false
#define MB_DATA_MAP						<lib/Modbus/Inc/ModbusDataMap.h>
#define MB_32_BITS_REGISTERS			false
#define MB_COILS_ENABLED				1   // discrete output (relay, etc.) [R/W]
#define MB_INPUTS_ENABLED				1   // discrete input (button, limit switch, etc.) [R]
#define	MB_HOLDING_REGISTERS_ENABLED	1   // analogue output (typically 0-10 V, 4-20 mA) (setting speed or temperature, etc.) [R/W]
#define MB_INPUT_REGISTERS_ENABLED		1   // analog input (temperature, pressure, etc.) [R]
#else
...
// Device settings (DSP f28379D)
//#define CPU_FREQ            200
//#define LOW_SPEED_CLOCK     50000000
//#define LOW_SPEED_CLOCK   30000000

// Device settings (DSP f28379D LAUNCH_XL)
#define CPU_FREQ            100
#define LOW_SPEED_CLOCK     25000000

// Serial settings ========================================
//#define SERIAL_BAUDRATE 	19200 //9600 //38400
#define SERIAL_BAUDRATE     115200 //9600 //38400
#define SERIAL_PARITY 		SERIAL_PARITY_NONE
#define SERIAL_BITS_NUMBER 	8

#define SERIAL_START_STOP_NUMBER_BITS	 1 // 2 //
...
//#define mbT35 (unsigned long) ( (unsigned long)(SERIAL_FRAME_SIZE) * (unsigned long)(4000000 / SERIAL_BAUDRATE) )
